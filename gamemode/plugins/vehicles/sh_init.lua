...
list.Set(
	"Vehicles", "Jeep", {
		...
		CustomViews = {FirstPerson = Vector(0, 0, 0)},
...
list.Set(
	"Vehicles", "trabbi", {
		...
		Passengers = {{Pos = Vector(16, 2, 12), Ang = Angle(0, 0, 0)}},
		...
		KeyValues = {vehiclescript = "scripts/vehicles/trabbi.txt"},
		Doors = {
...
list.Set(
	"Vehicles", "tideslkw", {
		...
		Passengers = {{Pos = Vector(21, -78, 40), Ang = Angle(0, 0, 0)}},
		...
		Horn = {Sound = "vu_horn_old.wav", Pitch = 90},
		KeyValues = {vehiclescript = "scripts/vehicles/tideslkw.txt"},
		Doors = {
...
list.Set(
	"Vehicles", "citron7cv", {
		...
		Passengers = {
			{Pos = Vector(16, 9, 26), Ang = Angle(0, 0, 0)},
			{Pos = Vector(0, 44, 23), Ang = Angle(0, 0, 0)},
		},
		Horn = {Sound = "vu_horn_old.wav", Pitch = 90},
		Customexits = {
			Vector(-90, 36, 22),
		...
		KeyValues = {vehiclescript = "scripts/vehicles/citron7cv.txt"},
		Doors = {
...
list.Set(
	"Vehicles", "copcar", {
		...
		Horn = {Sound = "vu_horn_simple.wav", Pitch = 90},
		SeatType = "Seat_Jeep",
		KeyValues = {vehiclescript = "scripts/vehicles/copcar.txt"},
	}
);
...
v = {
	...
	KeyValues = {vehiclescript = "scripts/vehicles/corvette_blue.txt"},
}
...
v = {
	...
	SeatType = "Seat_Jeep",
	HideSeats = true,
	KeyValues = {vehiclescript = "scripts/vehicles/golf_white.txt"},
	Doors = {
