...
PLUGIN.EntitiesToDelete = {
	all = {"weapon_", "item_"},
	rp_evocity_v2d = {"prop_physics", "func_breakable", "trigger_teleport"},
	rp_christmastown = {"func_button", "prop_physics", "prop_ragdoll"},
	rp_evocity_v17x = {
...
PLUGIN.SpecificEntitiesToDelete = {
	rp_tb_city45_v02n = {
		func_movelinear = {{Vector(2804.8884, 1413.8890, 182.0313), 512}},
	},
	rp_evocity_v2d = {
		func_brush = {
		...
		func_physbox_multiplayer = {{Vector(2924.5828, 4572.7065, 64.9668), 16}},
		func_door_rotating = {{Vector(-7828, -8961, 1788), 30}},
	},
}
	...
	rp_evocity_v2d = { --	14157.5742,
		{
			...
			Angle(00, 00, -90),
			Vector(-6020.0000, 14502.7637, 437.4147),
		},
		{
			"prop_physics",
			"models/props_buildings/building_002a.mdl",
			Angle(00, 00, 90),
			Vector(-6020.0000, 11693.2842, 443.3592),
		},

		{
			...
			Angle(00, 90, 90),
			Vector(-7810.2871, -8611.6387, -312.6482),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 5315.9014, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 5058.7207, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 4801.54, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 4544.3594, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 4287.1787, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 4029.998, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 3772.8174, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 3515.6367, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 3258.4561, 391.4228),
		},
		{
			"prop_physics",
			"models/props_wasteland/interior_fence002d.mdl",
			Angle(90, 180, 180),
			Vector(-672.8117, 3001.2754, 391.4228),
		},
...
function PLUGIN:InitPostEntity()
	...
	for _, ent in ipairs(ents.GetAll()) do
		...
		if (not next and self.SpecificEntitiesToDelete[mapname] and
			self.SpecificEntitiesToDelete[mapname][iclass]) then
			pos = ent:GetPos();
	...
	if (self.KillBoxes[mapname]) then
		timer.Create(
			"Killboxes", 0.1, 0, killfunc, self.KillBoxes[mapname],
			#self.KillBoxes[mapname]
		);
	end
	-- Spawn stuff for the map
	if (not self.EntitiesToSpawn[mapname]) then
		return
	end
	...
	for _, data in pairs(self.EntitiesToSpawn[mapname]) do
		...
		if (not IsValid(ent)) then
			...
			if (IsValid(phys)) then
				...
				ErrorNoHalt(
					"Applejack (Cleanmap): Model has no physics! " .. data[1] .. "\n"
				);
			end
