...
usermessage.Hook("AccessChange", function(msg)
	handleent(msg:ReadShort(), msg:ReadBool() or nil);
end);

usermessage.Hook("AccessReset", function(msg)
...
timer.Create("Applejack - Entity Library - Table Cleaner", GM.Config["Earning Interval"], 0, function()
	for ent in pairs(GM.AccessableEntities) do
